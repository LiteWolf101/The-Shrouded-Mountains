...
public class BiomeSteppe extends Biome {
    private static BiomeProperties properties = new BiomeProperties("Steppe").setBaseHeight(0.45F).setHeightVariation(0.3F).setTemperature(0F).setRainfall(0.5F).setSnowEnabled();
