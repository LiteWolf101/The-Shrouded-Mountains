...
public class BiomeGlaciers extends Biome {
    private static BiomeProperties properties = new BiomeProperties("Glaciers").setBaseHeight(0F).setHeightVariation(0.7F).setTemperature(0F).setRainfall(0.5F).setSnowEnabled();
