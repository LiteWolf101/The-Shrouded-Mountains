...
import com.litewolf101.the_shrouded_mountains.world.biome.genlayer.ModGenLayer;
...
public class ModBiomeProvider extends BiomeProvider {
    public static List<Biome> allowedBiomes = Lists.newArrayList(ModBiomes.TUNDRA, ModBiomes.STEPPE, ModBiomes.GLACIERS);
    ...
    public ModBiomeProvider(World world) {
        ...
        biomeGenLayer = ModGenLayer.initializeAllBiomeGenerators(world.getSeed(), world.getWorldInfo().getTerrainType())[1];
    }
